          ...
          <div className="p-10">
            ...
            <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 p-4 ml-12 mb-5">
              ...
              >
                <img
                  ...
                  src="https://topsoftwarecompanies.co/front_assets/img/company-logo/jiasaz1.jpg"
                  alt="not loaded"
                />

                <div className=" flex flex-col justify-center items-center">
                  <h5 className="mb-2 pt-2 pl-2 text-xl font-semibold  text-amber-400">
                    Company Name: Jiasaz
                  </h5>

                  <p className=" mb-3 pl-2 font-normal text-gray-700 ">
                    Requied: UX/UI Designer
                  </p>
                  <p className="mb-3 pl-2 font-normal text-gray-700 ">
                    Location:Slemani
                  </p>
              ...
              >
                ...
                <div className="pl-2 flex flex-col justify-center items-center">
                  <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">
                    Company Name: Asiacell
                  </h5>

                  <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    Requied: Web Devloper
                  </p>
                  <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    Location: Erbil
                  </p>
              ...
              >
                <img
                  className="rounded-t-lg h-72 w-96 object-cover"
                  src="https://i0.wp.com/hybridsim.com/wp-content/uploads/2022/06/Korek-Logo.jpg?fit=1366%2C768&ssl=1"
                  alt="not loaded"
                />
              ...
              >
                <img
                  className="rounded-t-lg h-72 w-96 object-cover"
                  src="https://t4.ftcdn.net/jpg/03/32/03/89/360_F_332038928_Jg6DZ3eJaWVOmf9hrZrz6JisyM35KdfT.jpg"
                  alt="not loaded"
                />
            ...
            <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 p-4 ml-12 mb-5">
              ...
              >
                <img
                  className="rounded-t-lg h-72 w-96 object-cover"
                  src="https://is4-ssl.mzstatic.com/image/thumb/Purple115/v4/2d/c1/cf/2dc1cf7b-399c-6021-b253-2185bfe73148/source/512x512bb.jpg"
                  alt="not loaded"
                />

                <div className="pl-2 flex flex-col justify-center items-center">
                  <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">
                    Company Name: Fastlink
                  </h5>

                  <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    Requierd: HR & Training
                  </p>
                  <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    Location:Halabja
                  </p>
            ...
            <div className=" container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10  p-4 ml-12 mb-5">
              ...
              >
                <img
                  className="rounded-t-lg h-72 w-96 object-cover"
                  src="https://seeklogo.com/images/A/Avesta_Design-logo-E886C61AF8-seeklogo.com.png"
                  alt="not loaded"
                />

                <div className="pl-2 flex flex-col justify-center items-center">
                  <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">
                    Company Name: Avesta Group{" "}
                  </h5>
              ...
              >
                <img
                  className="rounded-t-lg h-72 w-96 object-cover"
                  src="https://play-lh.googleusercontent.com/inp5-0G0hA_--TUuKstE5t-5syoLv4x4p47DqxRzXLeAg-NdDauvXtOe_ggfF5K4aQ"
                  alt="not loaded"
                />

                <div className="pl-2 flex flex-col justify-center items-center">
                  <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">
                    Company Name: Nass Wallet
                  </h5>
              ...
              >
                <img
                  className="rounded-t-lg h-72 w-96 object-cover"
                  src="https://suncode.co/wp-content/uploads/freshizer/fb82075546ccfb880224f8558813c649_dlzar-construction-co-suncode-erbil-logo-web-design_-768-c-90.png"
                  alt="not loaded"
                />

                <div className="pl-2 flex flex-col justify-center items-center">
                  <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">
                    Company Name: Dlzar Construction
                  </h5>
              ...
              >
                <img
                  className="rounded-t-lg h-72 w-96 object-cover"
                  src="https://brandkri.com/wp-content/uploads/2019/12/SardarGroup.png"
                  alt="not loaded"
                />
                ...
                <div className="pl-2 flex flex-col justify-center items-center">
                  <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">
                    {" "}
                    {delimiter(Text, 20)}Company Name: Sardar Group
                  </h5>
