...
<Link to='/freelancerinfo' className="h-min w-64  bg-white pb-4  rounded-lg  border-gray-200 shadow-md ">
...
<Link to='/freelancerinfo' className="h-min w-64  bg-white pb-4  rounded-lg  border-gray-200 shadow-md 0">
...
<Link to='/freelancerinfo' className="h-min w-64  pb-2 bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
