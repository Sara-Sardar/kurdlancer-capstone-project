...
export default function FreelancerInfo() {
 ...
 <Link to='/emails' className="h-min w-96  bg-white pb-4  rounded-lg  border-gray-200 shadow-md  ">
                          ...
                          <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">Freelancer Name: Alan Soran</h5>
                      
                          <p className=" mb-3 font-normal text-gray-700 ">Requied Skills: UX/UI Designer</p>
                          <p className="mb-3 font-normal text-gray-700 ">Location:Slemani</p>
                           ...
                           <p className=" mb-3 pl-2 font-normal text-gray-700 ">payment method: 1 page/100$ </p>
                           <p className="mb-3 pl-2 font-normal text-gray-700 ">Project deadline: 1 Hour/100$.</p>
                           <p className=" mb-3 pl-2 font-normal text-gray-700 ">Email: Ala.soran@gmail.com</p>
                           ...
                           <p className="mb-3 pl-2 font-normal text-gray-700 ">CV</p>
                            ...
                            Hire Freelancer
                            <svg aria-hidden="true" className="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRulclipRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                            </p>
                      </div>
                  </Link>
