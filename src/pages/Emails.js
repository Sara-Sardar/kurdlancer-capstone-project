          ...
          <div className='container mx-auto h-60  p-12 rounded-md  bg-amber-400 '>
            <div className=' text-white md:flex flex  space-x-96'>
                <div className='p-5 my-5 mx-10'>
                      <p className='text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-5xl'>Emails</p>
                </div>
             </div>
          </div>
        </div>
...
<div className='container mx-auto  p-12 rounded-md mt-10 bg-amber-400'></div>
    </SecondLayout>
  )
}
