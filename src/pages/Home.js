...
{/*Dropdown menu */}
<div id="dropdownLeftStart" class="z-20 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 block" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="right-start" > {/*style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(351.6px, 0px, 0px);"*/} 
...
<div id="dropdownRightStart" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="right-start" > {/*style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(559.2px, 20px, 0px);*/}
    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRightStartButton">
      <li>
        <a href="./freelansers" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Dashboard</a>
      </li>
      <li>
        <a href="./freelansers" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Settings</a>
      </li>
      <li>
        <a href="./freelansers" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Earnings</a>
      </li>
      <li>
        <a href="./freelansers" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sign out</a>
      </li>
    </ul>
</div>
...
<Carousel
    ...
    >
     ...
     <div className=' grid grid-cols-1 gap-y-80 gap-x-80 pl-96 pb-10 ml-96 mt-5'>
                ...
                {/*card4*/}
                <div className=' grid grid-cols-1 gap-y-7 gap-x-10 pl-0 pb-10 ml-20 mt-5'>
