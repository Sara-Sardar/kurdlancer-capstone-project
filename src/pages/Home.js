        ...
        <div>1
          ...
          <div>2
                  ...
                  <div className=' grid grid-cols-1  pl-96 pb-10 ml-96 mt-5'>
                              ...
                              {/*card2*/}
                              <div className=' grid grid-cols-1 gap-y-80 gap-x-80 pl-96 pb-10 ml-96 mt-5'> <Link to='/' className="h-min w-64  bg-white pb-4  rounded-lg  border-gray-200 shadow-md ">
                              ...
                              {/*card4*/}
                              <div className=' grid grid-cols-1 gap-y-80 gap-x-80 pl-96 pb-10 ml-96 mt-5'><Link to='/' className="h-min w-64  pb-2 bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
