  ...
  return (
    ...
    >
     ...
     <div className=' grid grid-cols-4 gap-y-7 gap-x-0 pl-0 pb-10 ml-20 mt-5'>
                    ...
                    <Link to='/jobs' className="h-min w-72  bg-white pb-4  rounded-lg  border-gray-200 shadow-md ">
                            ...
                            <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">Company Name: Jiasaz</h5>
                        
                            <p className=" mb-3 font-normal text-gray-700 ">Requied: UX/UI Designer</p>
                ...
                <Link to='/jobs' className="h-min w-72  bg-white pb-4  rounded-lg  border-gray-200 shadow-md 0">
                ...
                <Link to='/jobs' className="h-min w-72  pb-2 bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
             ...
             <div className=' grid grid-cols-4 gap-y-7 gap-x-0 pl-0 pb-10 ml-20'>
                    ...
                    <div className=' grid grid-cols-4 gap-y-7 gap-x-0 pl-0 pb-10 ml-20'>
                        ...
                        <Link to='/jobs' className="h-min w-72  pb-2 bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <img className="rounded-t-lg h-72 w-96 object-cover" src="https://seeklogo.com/images/A/Avesta_Design-logo-E886C61AF8-seeklogo.com.png" alt="not loaded" />
                                ...
                                <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">Company Name: Avesta</h5>
                ...
                <Link to='/jobs' className="h-min w-72 pb-2  bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <img className="rounded-t-lg h-72 w-96 object-cover" src="https://play-lh.googleusercontent.com/inp5-0G0hA_--TUuKstE5t-5syoLv4x4p47DqxRzXLeAg-NdDauvXtOe_ggfF5K4aQ" alt="not loaded" />
                            ...
                            <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">Company Name: Nass W.</h5>
                ...
                <Link to='/jobs' className="h-min w-72 pb-2  bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <img className="rounded-t-lg h-72 w-96 object-cover" src="https://suncode.co/wp-content/uploads/freshizer/fb82075546ccfb880224f8558813c649_dlzar-construction-co-suncode-erbil-logo-web-design_-768-c-90.png" alt="not loaded" />
                            ...
                            <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">Company Name: Dlzar C.</h5>
                  ...
                  <Link to='/jobs' className="h-min w-72  pb-2 bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <img className="rounded-t-lg h-72 w-96 object-cover" src="https://brandkri.com/wp-content/uploads/2019/12/SardarGroup.png" alt="not loaded" />
                            ...
                            <h5 className="mb-2 pt-2 text-xl font-semibold  text-amber-400">Company Name: Sardar</h5>
