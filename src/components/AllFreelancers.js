...
export default function AllFreelancers() {
  return (
    ...
    {/*start carasoul1*/}
    <div className='container grid grid-cols-2 grid-row-4 gap-0 divide-x-2  ml-10  pt-5'>

        {/*card1*/}

        <Link to='./freelancers' className="h-min w-64  bg-white pb-4  rounded-lg  border-gray-200 shadow-md mb-6 m-5">
        ...
        <p className="inline-flex  py-2 px-3 bg-amber-400  text-sm font-medium hover:bg-amber-300 rounded-md text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-amber-400 focus:ring-white">
        View
...
<Link to='/' className="h-min w-64  bg-white pb-4  rounded-lg  border-gray-200 shadow-md m-5  ">
...
<Link to='/' className="h-min w-64  bg-white pb-4  rounded-lg  border-gray-200 shadow-md 0 m-5 ">
...
<Link to='/' className="h-min w-64  pb-2 bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-5 ">
...
<div className='container grid grid-cols-2 grid-row-4 gap-0 divide-x-2  ml-10  pt-5 '>
    ...
    <Link to='/' className="h-min w-64 pb-2  bg-white rounded-lg  border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mb-6">
