  ...
  return (
    ...
    <div className="md:flex md:justify-between ">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div className=''>
                <a href='/' className="self-center text-white text-2xl font-semibold whitespace-nowrap dark:text-white ">KURDLANCER</a>
                <ul className="text-blue-900 dark:blue-900 mt-4">
                    <li className="mb-4">
            ...
            <div>
               ...
               {/*<div className="self-center text-white text-2xl font-semibold whitespace-nowrap dark:text-white">KURDLANCER</div>
               <div className="self-center text-white text-sm font-semibold whitespace-nowrap dark:text-white">About Us</div>
               <div className="self-center text-white text-sm font-semibold whitespace-nowrap dark:text-white">Contact Us</div>
            */}
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Resources</h2>
                <ul className="text-blue-900 dark:blue-900">
                    <li className="mb-4">
            ...
            <div>
                ...
                <ul className="text-blue-900 dark:blue-900">
                    ...
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Behance</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://www.instagram.com/accounts/login/" className="text-white hover:text-blue-900 dark:hover:text-white">
            ...
            <a href="https://twitter.com/i/flow/login" className="text-white hover:text-blue-900 dark:hover:text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path></svg>
                <span className="sr-only">Twitter page</span>
            </a>
            <a href="https://github.com/Sara-Sardar" className="text-white hover:text-blue-900 dark:hover:text-white">
            ...
            <a href="https://www.linkedin.com/in/sara-sardar-b05246224/" className="text-white hover:text-blue-900 dark:hover:text-white">
