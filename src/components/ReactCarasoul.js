...
export default function ReactCarasoul() {
  return (
    ...
    >
                <div >
                    <p className='p-4 absolute top-2 left-1/2 transform -translate-x-1/2  text-md font-medium text-white' >Ads: You can advertise for your bussiness or products here.</p>
