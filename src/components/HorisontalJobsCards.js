...
export default function HorisontalJobsCards() {
  return (
    <div>
      <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-3xl md:text-3xl">
      ...
      <div className="flex justify-center">
        <Link
          to="/jobs"
          className=" shadow-md hover:shadow-lg  bg-blue-900 hover:bg-blue-800 text-white px-6 py-4 rounded-lg text-xl font-semibold "
        >
          View More Jobs
        </Link>
      </div>
